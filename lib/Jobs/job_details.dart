...
import 'package:get_jobs/Services/global_methods.dart';
import 'package:get_jobs/Services/global_variables.dart';
import 'package:get_jobs/Widgets/comments_widget.dart';
...
class _JobDetailsScreenState extends State<JobDetailsScreen> {
  ...
  applyForJob() {
    final Uri params = Uri(
      ...
      path: emailCompany,
      query:
          'subject = Applying for $jobTitle&body = Hello, please attach Resume 0r CV file',
    );
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [Colors.blue.shade800, Colors.cyanAccent],
                                      ...
                                      itemBuilder: (context, index)
                                        {
                                          return CommentWidget(
                                            commentId: snapshot.data!['jobComments'][index]['commnetId'],
